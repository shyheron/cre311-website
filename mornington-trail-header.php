    ...
    <div class="container">
      ...
      <div class="row text-left"><!--  a row that gives us access to the BS columns-->
                    ...
                    <div class="col-md-4 trail-map-description">
                      <h1 class="text-left"><?php the_field('titleformornington'); ?></h1>
                      <p class="text-left" ><?php the_field('paragraphformorningtonintro'); ?></p>
                    </div>
                    <div class="col-md-8">
                    <img class="img-fluid" alt=“trail-image” src="<?php the_field('morningtonimage');?>">
                    </div>
                </div>    
