    ...
    <div class="container">
      ...
      <div class="row text-left"><!--  a row that gives us access to the BS columns-->
                    ...
                    <div class="col-md-4 trail-map-description">
                      <h1 class="text-left"><?php the_field('titleforkarakamia'); ?></h1>
                      <p class="text-left" ><?php the_field('paragraphforkarakamiaintro'); ?></p>
                    </div>
                    <div class="col-md-8">
                    <img class="img-fluid" alt=“trail-image” src="<?php the_field('karakamiaimage');?>">
                    </div>
                </div>    
